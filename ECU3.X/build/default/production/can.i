...
int can_receive(uint16_t *msg_id, uint8_t *data, uint8_t *len)
{
 if (!RXB0FUL) {
    ...
    uint16_t sidh = RXB0SIDH;
    uint16_t sidl = (RXB0SIDL >> 5) & 0x07;
    *msg_id = (sidh << 3) | sidl;
 ...
 uint8_t dlc = RXB0DLC & 0x0F;
    ...
    *len = dlc;
    ...
    void can_transmit(uint16_t msg_id, const uint8_t *data, uint8_t len)
{
 TXB0EIDH = can_payload[0];
 TXB0EIDL = can_payload[1];


 TXB0SIDH = can_payload[2];
 TXB0SIDL = can_payload[3];

 TXB0DLC = can_payload[4];
 TXB0D0 = can_payload[5];
 TXB0D1 = can_payload[6];
 TXB0D2 = can_payload[7];
 TXB0D3 = can_payload[8];
 TXB0D4 = can_payload[9];
 TXB0D5 = can_payload[10];
 TXB0D6 = can_payload[11];
 TXB0D7 = can_payload[12];
