...
# 11 "ecu3_main.c" 2
# 1 "./message_handler.h" 1
# 11 "./message_handler.h"
...
void main(void) {
    config();
    clcd_print("SP G TM  RPM IND", (0x80 + (0)));
    uint8_t speed = 0, gear_pos = 0, engine_temp = 0,delay = 0;
    int i=0;
    uint8_t rx_data[8];
    char buff[8];
    while (1) {
        ...
        if (can_receive(&rx_id, rx_data, &rx_len)) {
            ...
            switch (rx_id) {
                case 0x1:
                    rx_data[2] = '\0';
                    clcd_print(rx_data, (0xC0 + (0)));
                    break;

                case 0x2:
                    char temp = rx_data[0];
                    switch (temp) {
                        case '1': clcd_print("N", (0xC0 + (3)));
                            break;
                        case '2': clcd_print("1", (0xC0 + (3)));
                            break;
                        case '3': clcd_print("2", (0xC0 + (3)));
                            break;
                        case '4': clcd_print("3", (0xC0 + (3)));
                            break;
                        case '5': clcd_print("4", (0xC0 + (3)));
                            break;
                        case '6': clcd_print("5", (0xC0 + (3)));
                            break;
                        case '7': clcd_print("6", (0xC0 + (3)));
                            break;
                        case '8': clcd_print("R", (0xC0 + (3)));
                            break;
                        case '9': clcd_print("C", (0xC0 + (3)));
                            break;
                    }
                    break;
                ...
                case 0x4:
                    rx_data[rx_len] = '\0';
                    clcd_print(rx_data, (0xC0 + (5)));
                    break;

                case 0x3:
                    rx_data[rx_len] = '\0';
                    clcd_print(rx_data, (0xC0 + (9)));
                    break;

                case 0x5:
                    if (rx_data[0] == '1'){
# 95 "ecu3_main.c"
                        clcd_print("L ", (0xC0 + (14)));
                    }
                    else if (rx_data[0] == '2') {
                        PORTB = 0x00;
                        clcd_print("O ", (0xC0 + (14)));
                    }
                    else if (rx_data[0] == '3') {
# 115 "ecu3_main.c"
                        clcd_print("R", (0xC0 + (14)));
                    }
                    else if (rx_data[0] == '4') {
# 131 "ecu3_main.c"
                        clcd_print("H", (0xC0 + (14)));
                    }
                    break;
            }
        }
