...
void can_receive(uint16_t *msg_id, uint8_t *data, uint8_t *len)
{
 ...
 if (RXB0FUL)
 {
  ...
  can_payload[0] = RXB0EIDH;
  can_payload[1] = RXB0EIDL;
  can_payload[2] = RXB0SIDH;
  can_payload[3] = RXB0SIDL;
  can_payload[4] = RXB0DLC;
  can_payload[5] = RXB0D0;
  can_payload[6] = RXB0D1;
  can_payload[7] = RXB0D2;
  can_payload[8] = RXB0D3;
  can_payload[9] = RXB0D4;
  can_payload[10] = RXB0D5;
  can_payload[11] = RXB0D6;
  can_payload[12] = RXB0D7;
...
void can_transmit(uint16_t msg_id, const uint8_t *data, uint8_t len)
{
    ...
    TXB0SIDH = (uint8_t)(msg_id >> 3);
    TXB0SIDL = (uint8_t)((msg_id & 0x7) << 5);
